...
python3.5 helper_04_load_blocks.py
...
psql -d batch_network -U snow << EOD
  ...
  CREATE TABLE "public"."blocks" (gid serial,
      "statefp10" smallint,
      "countyfp10" smallint,
      "tractce10" int,
      "blockce" int,
...
psql -d batch_network -U snow << EOD
  ...
  ALTER TABLE blocks DROP COLUMN gid,
  		     DROP COLUMN partflg,
...
psql -d batch_network -U snow -f helper_04_weight_tracts.sql
